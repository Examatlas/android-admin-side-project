        ...
        setupSpinner(contentDropdown, contentItems, new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (contentItemsSelected.equals("Blog")){
                        loadFragment(new BlogCreateDeleteFragment());
                        currentFragment = new BlogCreateDeleteFragment();
                        drawerDialog.dismiss();
                    } else if(contentItemsSelected.equals("Current Affairs")){
                        loadFragment(new CurrentAffairCreateDeleteFragment());
                        currentFragment = new CurrentAffairCreateDeleteFragment();
                        drawerDialog.dismiss();
