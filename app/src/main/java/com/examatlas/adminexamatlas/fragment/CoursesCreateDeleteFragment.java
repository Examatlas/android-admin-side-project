...
import com.examatlas.adminexamatlas.adapters.ShowAllCoursesAdapter;
...
public class CoursesCreateDeleteFragment extends Fragment {
    ...
    ShowAllCoursesAdapter showAllCoursesAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_create_courses, container, false);
        ...
        showAllCourseModelArrayList = new ArrayList<>();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (showAllCoursesAdapter != null) {
                    showAllCoursesAdapter.filter(newText);
                }
                return true;
            }
        });
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status) {
                                ...
                                showAllCourseModelArrayList.clear(); // Clear the list before adding new items
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    ShowAllCourseModel courseModel = new ShowAllCourseModel(courseID, title, price, image, createdDate);
                                    showAllCourseModelArrayList.add(courseModel);
                                }

                                // Update the original list in the adapter
                                if (showAllCoursesAdapter != null) {
                                    showAllCoursesAdapter.updateOriginalList(showAllCourseModelArrayList);
                                }

                                // Check if the list is empty
                                if (showAllCourseModelArrayList.isEmpty()) {
                                    noDataLayout.setVisibility(View.VISIBLE);
                                    courseProgress.setVisibility(View.GONE);
                                } else {
                                    if (showAllCoursesAdapter == null) {
                                        showAllCoursesAdapter = new ShowAllCoursesAdapter(CoursesCreateDeleteFragment.this, showAllCourseModelArrayList);
                                        showAllCoursesRecycler.setAdapter(showAllCoursesAdapter);
                                    } else {
                                        showAllCoursesAdapter.notifyDataSetChanged();
                                    }
                                }
                            } else {
    ...
    private void openCreateCoursesDialog(){
        ...
        createCoursesDialogBox.setContentView(R.layout.create_course_dialog);
